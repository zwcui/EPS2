...
<html lang="zh-cn">
<%
	String sProductID = java.net.URLDecoder.decode(request.getParameter("ProductID"),"UTF-8");
	sProductID = java.net.URLDecoder.decode(sProductID,"UTF-8");
...
<!-- 				</button> -->
	...
	var sourceDataUrl = "${pageContext.request.contextPath}/ShowBusinessOrderByProductID";
	var grid_data;
