...
<html lang="zh-cn">
<%
	String sOrderState = java.net.URLDecoder.decode(request.getParameter("OrderState"),"UTF-8");
	sOrderState = java.net.URLDecoder.decode(sOrderState,"UTF-8");
	String sTitle = java.net.URLDecoder.decode(request.getParameter("Title"),"UTF-8");
	sTitle = java.net.URLDecoder.decode(sTitle,"UTF-8");
%>
<head>
...
<!-- 				</button> -->
	...
	<script>
	var b = new Base64();  
	var sOrderState = "<%=sOrderState%>";
	var sourceDataUrl = "${pageContext.request.contextPath}/ShowBusinessOrderByState";
	var grid_data;
...
// 							multiselect : true,
		...
		function viewOrder() {
			...
			if (selectRow.length < 1
				...
				var sPageTitle = "<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode(sTitle,"UTF-8"),"UTF-8")%>";
				var sSerialNo = b.encode(selectRow.serialNo);
				var sRightType= "<%=java.net.URLEncoder.encode(java.net.URLEncoder.encode("ReadOnly","UTF-8"),"UTF-8")%>";
