...
<%
	...
	String sFlowSerialNo = request.getParameter("FlowSerialNo");
...
<body class='main page' >
	...
	<div class="page-content" id="pagecontent">
		<div class='panel panel-default grid'>
				<table id="flowOpinion" class="table table-striped table-bordered table-hover no-margin-bottom no-border-top"></table>
				<div id="flowOpinion-pager"></div>
	...
	<script>
	var b = new Base64(); 
	var opinionDataUrl = "${pageContext.request.contextPath}/ShowFlowOpinions";
	var opinion_data;
	var sFlowSerialNo = "";
	var sRightType = "";
	function initOpinionList() {
		var data= {
			flowSerialNo : sFlowSerialNo,
		...
		$
				.ajax({
					...
					success : function(response) {
						var opinion_data = response.data;
						var colnames = response.colNames;
						var colmodel = modelPreTreat(response.column);
						var lastSel;
						var grid_selector = "#flowOpinion";
						var pager_selector = "#flowOpinion-pager";
...
// 								showQuery: true
	...
	$(document).ready(function() { 
		sFlowSerialNo = b.decode("<%=sFlowSerialNo%>");
		sRightType = "<%=sRightType %>";
		initOpinionList();
	});
		
	function refreshflowOpinion(grid_selector) {
		sIsInEdit = false;
		$.ajax({
			url : opinionDataUrl,
			dataType : 'json',
